  ...
  try {
    ...
    const standardTables = [
      ...
      },
      {
        ...
        fields: [
          ...
          { name: 'dieuKien', label: 'Điều kiện (Đất/Nước/SP)', type: 'select', options: ['Đất/Giá thể', 'Nước tưới', 'Nước sơ chế', 'Sản phẩm'], required: true },
          { name: 'tacNhan', label: 'Tác nhân gây ô nhiễm', type: 'multi-select', options: ['Kim loại nặng', 'Vi sinh vật', 'Dư lượng thuốc BVTV', 'Độc tố vi nấm trong sản phẩm', 'Khác'], required: true },
      ...
      },
      {
        ...
        isMultiRow: true,
        fields: [
          { name: 'thoiGian', label: 'Thời gian', type: 'date', required: true },
          { name: 'tenVatTu', label: 'Tên vật tư', type: 'text', required: true },
      ...
      },
      {
        ...
        isMultiRow: true,
        fields: [
          { name: 'thoiGian', label: 'Thời gian thực hiện', type: 'date', required: true },
          { name: 'maSoThua', label: 'Mã số thửa', type: 'text' },
          { name: 'loSx', label: 'Lô sản xuất', type: 'text', required: true },
      ...
      },
      {
        ...
        fields: [
          ...
          { name: 'maSoLo', label: 'Mã số lô thu hoạch', type: 'text', required: true },
          { name: 'tenSanPham', label: 'Tên sản phẩm', type: 'text', required: true },
          { name: 'sanLuong', label: 'Sản lượng (kg)', type: 'number', required: true },
    ...
    const mushroomTables = [
      ...
      },
      {
        ...
        fields: [
          { name: 'ngayThang', label: 'Ngày tháng', type: 'date', required: true },
          { name: 'dieuKien', label: 'Điều kiện', type: 'select', options: ['Đất/giá thể', 'Nước tưới', 'Sản phẩm'], required: true },
          { name: 'tacNhan', label: 'Tác nhân gây ô nhiễm', type: 'multi-select', options: ['Kim loại nặng', 'Vi sinh vật', 'Dư lượng thuốc BVTV', 'Độc tố vi nấm trong sản phẩm'], required: true },
          { name: 'danhGia', label: 'Đánh giá hiện tại', type: 'select', options: ['Đạt', 'Không đạt'], required: true },
          { name: 'bienPhap', label: 'Biện pháp xử lý đã áp dụng', type: 'text' }
        ]
      },
      {
        ...
        fields: [
          ...
          { name: 'maSoLo', label: 'Mã số lô giống', type: 'text', required: true },
      ...
      },
      {
        ...
        isMultiRow: true,
        fields: [
          { name: 'thoiGian', label: 'Thời gian mua/SX', type: 'date', required: true },
          { name: 'tenVatTu', label: 'Tên vật tư', type: 'text', required: true },
          { name: 'donViTinh', label: 'ĐVT', type: 'text' },
          { name: 'soLuong', label: 'Số lượng', type: 'number', required: true },
          { name: 'diaChiMua', label: 'Tên và địa chỉ mua', type: 'text' },
      ...
      },
      {
        ...
        fields: [
          ...
          { name: 'tenSanPham', label: 'Tên sản phẩm', type: 'text', required: true },
          { name: 'sanLuong', label: 'Sản lượng (kg)', type: 'number', required: true },
          { name: 'veSinhDungCu', label: 'Vệ sinh dụng cụ (Đ/K)', type: 'select', options: ['Đ', 'K'], required: true },
          { name: 'ngayBan', label: 'Ngày bán', type: 'date' },
          { name: 'soLuongBan', label: 'Số lượng bán (kg)', type: 'number' },
          { name: 'donViMua', label: 'Đơn vị thu mua/Địa chỉ', type: 'text' },
          { name: 'ghiChu', label: 'Ghi chú', type: 'text' }
