            ...
            <div className="w-full max-w-7xl px-6 md:px-12 py-4 flex items-center justify-between">
                ...
                <div className="hidden lg:flex justify-center items-center">
                    <Space size="large">
                        ...
                        <Button type="text" className="font-bold text-gray-600 hover:text-green-600 px-4 py-2 rounded-xl transition-all" onClick={() => navigate('/reference/tcvn')}>Tra cứu Văn bản</Button>
                ...
                >
                    <div className="flex flex-col gap-4">
                        ...
                        <Button type="text" className="text-left font-bold text-gray-600" onClick={() => { navigate('/reference/tcvn'); setMobileMenuOpen(false); }}>Tra cứu Văn bản</Button>
