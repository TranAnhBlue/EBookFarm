                    ...
                    <div className="floating-action-group">
                        ...
                        <Tooltip title="Liên hệ Zalo" placement="left">
                            ...
                            >
                                <svg viewBox="0 0 24 24" width="28" height="28" style={{ display: 'block' }}>
                                    <path 
                                        d="M12 3c-5.5 0-10 3.8-10 8.5 0 2.7 1.4 5.15 3.6 6.7.15.1.25.25.25.43l-.08 1.9c-.02.43.43.76.84.6l2.25-.86c.15-.05.32-.05.48-.02.8.2 1.63.3 2.5.3 5.5 0 10-3.8 10-8.5S17.5 3 12 3z" 
                                        fill="#ffffff"
                                    />
                                    <text 
                                        x="12" 
                        ...
                        <Tooltip title="Liên hệ Facebook Messenger" placement="left">
                            ...
                            >
                                <svg viewBox="0 0 24 24" width="28" height="28" style={{ display: 'block' }}>
                                    <path 
                                        d="M12 2C6.48 2 2 6.02 2 11c0 2.81 1.4 5.28 3.53 6.96.18.14.28.36.26.59l-.1 2.22c-.03.49.46.85.93.67l2.48-.96c.17-.07.36-.07.53-.02A9.88 9.88 0 0012 20c5.52 0 10-4.02 10-9S17.52 2 12 2zm3.81 8.2l-2.84 4.53c-.37.6-1.17.72-1.72.27L9.33 13.5c-.17-.14-.41-.14-.58 0L5.34 16c-.39.3-.9-.16-.68-.6l2.84-4.53c.37-.6 1.17-.72 1.72-.27l1.92 1.5c.17.14.41.14.58 0l3.41-2.5c.39-.3.9.16.68.6z" 
                                        fill="#ffffff"
                                    />
                                </svg>
                            </a>
